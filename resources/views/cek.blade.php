    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('AdminLTE/iframe.html') }}" class="nav-link">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  ...
                  @foreach($pollings as $polling)
                    <div class="post">
                      ...
                      @csrf
                      @foreach($polling->choice as $choice)
                      <div class="form-check mb-3">
                        <input class="form-check-input" type="radio" name="choice_id" id="flexRadioDefault1">
